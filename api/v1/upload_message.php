...
$contetn_message = $data['contetn_message'] ?? '';
...
$sql = "INSERT INTO Messages (
        ID, MessageThread_id  ,  ContetnMessage , IsDoctor,  DateSend  
    ) VALUES (
        :id , :message_thread_id , :contetn_message  , :is_doctor, :date_send 
    )";   
$stmt = $pdo->prepare($sql);
$stmt->execute([
    ':id' => $id,
    ':message_thread_id' => $message_thread_id,
   ':contetn_message' => $contetn_message,
   ':is_doctor' => $is_doctor,
    ':date_send' => $date_send 
